...
type
  ...
  TMFP = class
    ...
    public
      ...
      function Find(const aPath: String; const afileName: ansistring; var aResult: TBytes; var aExt: String;
        var APriorValues: TBytess; var ANextValues: TBytess; aPriorCount: integer = 0; aNextCount: integer = 0)
        : integer; overload;
...
function TMFP.Find(const aPath: String; const afileName: ansistring; var aResult: TBytes; var aExt: String;
  var APriorValues, ANextValues: TBytess; aPriorCount, aNextCount: integer): integer;
var
  aIndex    : TMFIndex;
...
begin
  ...
  begin
    FilePool      := true;
    PoolType      := 1; // 1 count 2 size 3 timeout 4
    Count         := 1;
    Size          := 0;
    TimeoutMinute := 0;
