...
class function TMExp.Exp(aExp: String; aEmptyReturnParam: Boolean; aData: Pointer; aDataParser: IMDataParser;
  aParams: TQjson): String;
begin
  result := TMExp.doExpression(aExp, aEmptyReturnParam, aData, aDataParser, aParams);
end;
            ...
            begin
              try
                ...
                begin
                  ...
                  if ipt.Parser.TryGetData(ipt.Data,ipt.Params, AVarName, true, r) then
                  begin
                    AResult := r;
                  end
                  else
