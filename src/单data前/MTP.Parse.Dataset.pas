...
type
  ...
  public
    ...
    function TryGetData(const aData: Pointer; const aParams: Pointer; const AName: String; const aAllowOwn: Boolean; var r: string): Boolean;
...
function TMDataParser_Dataset.TryGetData(const aData: Pointer; const aParams: Pointer; const AName: String; const aAllowOwn: Boolean;
