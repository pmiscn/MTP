  ...
  TLocalFileInfo = record
    ...
    public
      class function create(aFileName: string; AProgress: TOnProgress = nil; AFileProgress: TOnProgress = nil;
        AStatus: TOnStatus = nil; aDeep: integer = 0; aHasSub: boolean = true; aHasMd5: boolean = false)
...
begin
  if exepath = '' then
    exepath := extractfilepath(paramstr(0)); // getNowFileName
  result    := exepath;
end;
...
class function TLocalFileInfo.create(aFileName: string; AProgress: TOnProgress = nil; AFileProgress: TOnProgress = nil;
  AStatus: TOnStatus = nil; aDeep: integer = 0; aHasSub: boolean = true; aHasMd5: boolean = false): TLocalFileInfo;
var
  st      : Tstringlist;
  I, C    : integer;
  isCancel: boolean;
