...
type
  ...
  TMRange = record
    ...
    public
      class function create(aStart, aEnd: String): TMRange; static;
...
function TMNode.GetRangeEnd: String;
begin
...
function TMNode.GetRangeStart: String;
begin
...
procedure TMNode.SetRangeEnd(const value: String);
begin
...
procedure TMNode.SetRangeStart(const value: String);
begin
...
class function TMRange.create(aStart, aEnd: String): TMRange;
begin
...
begin
  ...
  begin
    ...
    begin
      self.RStart := (str); // strtoint
    end;
    // if IsDigitStr(es) then
    begin
      self.REnd := (es); // strtoint
    end;
    // 210725   if self.RStart + self.RStart = -2 then
