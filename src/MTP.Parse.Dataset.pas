...
type
  TMDataParser_Dataset = class(TMInterface, IMDataParser) // TObjectInterfaced
    public
      ...
      function TryGetData(const aData: Pointer; const aParams: Pointer;  const aRootData: Pointer;const AName: String; const aAllowOwn: Boolean;
...
function TMDataParser_Dataset.DataByPath(const aData: Pointer; const aParams: Pointer; const aPath: String): Pointer;
begin
...
function TMDataParser_Dataset.HasPath(const aData: Pointer; const aParams: Pointer; const aPath: String): Boolean;
begin
  // 这个是命名
...
function TMDataParser_Dataset.TryDataByPath(const aData: Pointer; const aParams: Pointer; const aPath: String;
  var outdata: Pointer): Boolean;
begin
  result := true; // TFDRdbmsDataSet(aData ;
end;

function TMDataParser_Dataset.TryGetData(const aData: Pointer; const aParams: Pointer;  const aRootData: Pointer;const AName: String;
