...
type
  ...
  TMExp = class
    public
      class function doExpression(aExp: String; aEmptyReturnParam: Boolean; aData: Pointer;
        aDataParser: IMDataParser): String;
      class function Exp(aExp: String; aEmptyReturnParam: Boolean; aData: Pointer; aDataParser: IMDataParser): String;
  end;
...
class function TMExp.Exp(aExp: String; aEmptyReturnParam: Boolean; aData: Pointer; aDataParser: IMDataParser): String;
begin
  result := TMExp.doExpression(aExp, aEmptyReturnParam, aData, aDataParser);
end;

class function TMExp.doExpression(aExp: String; aEmptyReturnParam: Boolean; aData: Pointer;
  aDataParser: IMDataParser): String;
var
  p       : pchar;
  Exp     : String;
            ...
            begin
              try
                ...
                begin
                  ...
                  if ipt.Parser.TryGetData(ipt.Data, AVarName, true, r) then
                  begin
                    AResult := r;
                  end
                  else
...
pubExpr := TQMathExpression.Create;
