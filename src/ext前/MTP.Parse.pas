...
var
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Result := Result + TMExp.doExpression(exp, true, aData, aDataParser);
        Inc(p, EXEndLLength);
        estart    := p - p1 + 1;
        isInStart := false;
  ...
  begin
    ...
    Result := TMExp.doExpression(exp, true, Data, aDataParser);
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        // outputdebugstring(Pchar(ajs.tostring));
        r := TMExp.doExpression(r, true, ajs, aDataParser);
        if r <> 'True' then
          Continue;
      end;
  ...
  var
    ...
    begin
      ...
      begin
        ...
        r := TMExp.doExpression(exp, true, Data, aDataParser);
        if r <> 'True' then
          exit;
      end;
  ...
  begin
    ...
    r      := TMExp.doExpression(r, true, aData, aDataParser);
    if r = 'True' then
    begin
      ...
      begin
        ...
        begin
          if TMExp.doExpression(replaceVarValue(nd.Condition, aLoopVar, aLoopValue), true, aData, aDataParser) = 'True' then
          begin
