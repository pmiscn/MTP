...
type
  ...
  TMDataOrigin = (mdoUnknow, mdoJson, mdoHttp, mdoMuDB, mdoFile, mdoPlugin, mdoQPlugin, mdoCustom);
...
begin
  ...
  end else if PStrSame(p, 'database', true) = 4 then
  begin
    self := TMDataOrigin.mdoMuDB;
  end else if PStrSame(p, 'db', true) = 4 then
  begin
    self := TMDataOrigin.mdoMuDB;
  end else if PStrSame(p, 'http', true) = 4 then
  begin
    self := TMDataOrigin.mdoHttp;
  end else if PStrSame(p, 'file', true) = 4 then
  begin
    self := TMDataOrigin.mdoFile;
  end else if PStrSame(p, 'plugin', true) = 4 then
  begin
    self := TMDataOrigin.mdoPlugin;
  end else if PStrSame(p, 'qplugin', true) = 4 then
  begin
